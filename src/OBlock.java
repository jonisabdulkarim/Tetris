class OBlock {
    private final static int[][] rota = {{1, 1}, {0, 1}, {1, 0}, {0, 0}};

    static void createBlock(Square[] sq){
        sq[0] = new Square(rota[0][0] + 4, rota[0][1] + 1, 'X');
        sq[1] = new Square(rota[1][0] + 4, rota[1][1] + 1, 'O');
        sq[2] = new Square(rota[2][0] + 4, rota[2][1] + 1, 'R');
        sq[3] = new Square(rota[3][0] + 4, rota[3][1] + 1, 'L');
    }
}
